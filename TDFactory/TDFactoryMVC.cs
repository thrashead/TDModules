...
namespace TDFactory
{
    public partial class TDFactory : Form
    {
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\jquery\\jquery.mask.js", FileMode.Create))
            {
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\jquery\\jquery.mousewheel-3.0.6.pack.js", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\jquery\\jquery.watermark.min.js", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("/*");
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\jquery\\jquery-1.10.2.min.js", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\jquery\\jquery-1.10.2.min.map", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
        ...
        void CreateTDTable()
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\tdTable.js", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\tdTable.css", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\ie7.css", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
        ...
        void CreateTDTableImages()
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream(bitmapBytes))
            {
                ...
                img.Save(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img\\downarrow.png");
            }
            ...
            using (MemoryStream memoryStream = new MemoryStream(bitmapBytes))
            {
                ...
                img.Save(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img\\false.png");
            }
            ...
            using (MemoryStream memoryStream = new MemoryStream(bitmapBytes))
            {
                ...
                img.Save(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img\\true.png");
            }
            ...
            using (MemoryStream memoryStream = new MemoryStream(bitmapBytes))
            {
                ...
                img.Save(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img\\uparrow.png");
            }
            ...
            using (MemoryStream memoryStream = new MemoryStream(bitmapBytes))
            {
                ...
                img.Save(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img\\loading.gif");
            }
        }
        ...
        {
            if (rdTDFramework.Checked)
            {
                projectFolder = projectName + " (TD)";
            }
            else if (rdEntityFramework.Checked)
            {
                projectFolder = projectName + " (EF)";
            }
            ...
            if (_tableName == null)
            {
                ...
                if (chkMVCHepsi.Checked)
                {
                    ...
                    if (!Directory.Exists(PathAddress + "\\" + projectFolder + "\\Views\\Shared\\Kontroller"))
                    {
                        Directory.CreateDirectory(PathAddress + "\\" + projectFolder + "\\Views\\Shared\\Kontroller");
                    }
                    ...
                    if (!Directory.Exists(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\Shared\\Kontroller"))
                    {
                        Directory.CreateDirectory(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\Shared\\Kontroller");
                    }
                    ...
                    if (rdTDFramework.Checked)
                    {
                        if (!Directory.Exists(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable"))
                        {
                            Directory.CreateDirectory(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable");
                        }

                        if (!Directory.Exists(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img"))
                        {
                            Directory.CreateDirectory(PathAddress + "\\" + projectFolder + "\\Content\\js\\tdTable\\img");
                        }
                    }

                    if (!Directory.Exists(PathAddress + "\\" + projectFolder + "\\Content\\files"))
                    {
                        Directory.CreateDirectory(PathAddress + "\\" + projectFolder + "\\Content\\files");
                    }
        ...
        void CreateMVCLayers(bool modelCreate)
        {
            ...
            if (chkMVCHepsi.Checked == true)
            {
                if (rdTDFramework.Checked)
                {
                    CreateMVCTDModelLayer();
                    CreateMVCTDViewLayer();
                    CreateMVCTDControllerLayer();
                    CreateTDWebConfig();
                    CreateTDWcfServis();
                    CreateStilScript();
                }
                ...
                {
                    CreateMVCEFModelLayer();
                    CreateMVCEFViewLayer();
                    CreateMVCEFControllerLayer();
                    CreateEFWebConfig();
                    CreateEFWcfServis();
                }
                    ...
                    using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                    {
                        ...
                        if (chkRTables.Checked == true)
                        {
                            ...
                            if (fkcListForeign.Count > 0)
                            {
                                foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                                {
                                    ...
                                    yaz.WriteLine("using Models." + PrimaryTableName + "Model;");
                                }
                            }
                        }
                        ...
                        if (chkRTables.Checked == true)
                        {
                            ...
                            if (fkcListForeign.Count > 0)
                            {
                                ...
                                {
                                    string PrimaryTableName = fkc.PrimaryTableName;
                                    yaz.WriteLine("\t\t\tthis." + PrimaryTableName + "List = new List<SelectListItem>();");
                                }
                            }
                        }
                        yaz.WriteLine("\t\t}");
                        ...
                        foreach (TableColumnNames column in columnNames)
                        {
                            if (column.TypeName != null)
                            {
                                ...
                                {
                                    yaz.WriteLine("\t\t[DBColumn(Name=\"" + column.ColumnName + "\")]");
                        ...
                        TableColumnNames lastColumn = tableColumnNames.Where(a => a.TableName == Table).ToList().Last();
        ...
        void CreateLayout()
        {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Views\\Shared\\Kontroller\\_Scriptler.cshtml", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\Shared\\Kontroller\\_Scriptler.cshtml", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("@using TDLibrary");
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\Shared\\Kontroller\\_Menu.cshtml", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("@using TDLibrary");
        ...
        void CreateMVCTDViewLayer()
        {
            ...
            foreach (string Table in selectedTables)
            {
                ...
                using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\" + Table + "\\Ekle.cshtml", FileMode.Create))
                {
                    using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                    {
                        yaz.WriteLine("@model Models." + Table + "Model." + Table);
                        yaz.WriteLine("");
                        yaz.WriteLine("@{");
                ...
                {
                    //Detay
                    using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\" + Table + "\\Detay.cshtml", FileMode.Create))
                    {
                        using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                        {
                            yaz.WriteLine("@model Models." + Table + "Model." + Table);
        ...
        void CreateMVCTDControllerLayer()
        {
            int i = 0;
            ...
            foreach (string Table in selectedTables)
            {
                ...
                yaz.WriteLine("using System.Web.Mvc;");
                yaz.WriteLine("using TDLibrary;");
                yaz.WriteLine("using TDFramework;");
                yaz.WriteLine("using TDFramework.Common;");
                yaz.WriteLine("using TDTools;");
                yaz.WriteLine("using Models." + Table + "Model;");
                ...
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\tTDConditions _table = TDConditions.DeserializeConditions(conditions);");
                yaz.WriteLine("\t\t\tList<string> fieldOptions = TDConditions.ReturnFieldNames(_table.Fields);");
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\tif (!_table.SearchText.IsNull())");
                yaz.WriteLine("\t\t\t{");
                yaz.WriteLine("\t\t\t\ttable.WhereList.Add(new Where(" + Table + "Columns." + searchText + ", _table.SearchText, Operators.LIKE));");
                yaz.WriteLine("\t\t\t}");
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\tif (_table.Top > 0)");
                yaz.WriteLine("\t\t\t{");
                yaz.WriteLine("\t\t\t\ttable.SelectSettings.Top = _table.Top;");
                yaz.WriteLine("\t\t\t}");
                yaz.WriteLine("");
                ...
                foreach (TableColumnNames column in tableColumnNames.Where(a => a.TableName == Table).ToList())
                {
                    yaz.WriteLine("\t\t\t\tcase \"" + column.ColumnName + "\": table.SelectSettings.OrderColumn = " + Table + "Columns." + column.ColumnName + "; break;");
                }

                if (identityColumns.Count > 0)
                {
                    yaz.WriteLine("\t\t\t\tdefault: table.SelectSettings.OrderColumn = " + Table + "Columns." + id + "; break;");
                }
                ...
                yaz.WriteLine("\t\t\t{");
                yaz.WriteLine("\t\t\t\tcase \"Asc\": table.SelectSettings.OrderBy = OrderBy.ASC; break;");
                yaz.WriteLine("\t\t\t\tcase \"Desc\": table.SelectSettings.OrderBy = OrderBy.DESC; break;");
                yaz.WriteLine("\t\t\t\tdefault: table.SelectSettings.OrderBy = OrderBy.ASC; break;");
                yaz.WriteLine("\t\t\t}");
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\tList<" + Table + "Columns> columns = new List<" + Table + "Columns>();");
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\tforeach (string fieldOption in fieldOptions)");
                yaz.WriteLine("\t\t\t{");
                yaz.WriteLine("\t\t\t\tif (Enum.IsDefined(typeof(" + Table + "Columns), fieldOption))");
                yaz.WriteLine("\t\t\t\t{");
                yaz.WriteLine("\t\t\t\t\t" + Table + "Columns _tempGP;");
                yaz.WriteLine("\t\t\t\t\tEnum.TryParse(fieldOption, out _tempGP);");
                yaz.WriteLine("\t\t\t\t\tcolumns.Add(_tempGP);");
                yaz.WriteLine("\t\t\t\t}");
                yaz.WriteLine("\t\t\t}");
                yaz.WriteLine("");
                ...
                if (chkRTables.Checked == true)
                {
                    if (fkcListForeign.Count > 0)
                    {
                        ...
                        foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                        {
                            ...
                            yaz.WriteLine("\t\t\t\t\t" + PrimaryTableName + " " + PrimaryTableName + " = new " + PrimaryTableName + "();");
                            yaz.WriteLine("");
                            yaz.WriteLine("\t\t\t\t\tTable<" + PrimaryTableName + "> table" + PrimaryTableName + " = new Table<" + PrimaryTableName + ">();");
                            yaz.WriteLine("\t\t\t\t\ttable" + PrimaryTableName + ".WhereList.Add(new Where(" + PrimaryTableName + "Columns." + fkc.PrimaryColumnName + ", item." + fkc.ForeignColumnName + "));");
                            yaz.WriteLine("\t\t\t\t\ttable" + PrimaryTableName + ".SelectSettings.Top = 1;");
                            yaz.WriteLine("\t\t\t\t\ttable" + PrimaryTableName + ".Select();");
                            yaz.WriteLine("");
                            yaz.WriteLine("\t\t\t\t\tif (table" + PrimaryTableName + ".HasData)");
                            yaz.WriteLine("\t\t\t\t\t{");
                            yaz.WriteLine("\t\t\t\t\t\t" + PrimaryTableName + " = (table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">).FirstOrDefault();");
                            yaz.WriteLine("\t\t\t\t\t\titem." + PrimaryTableName + "Adi = " + PrimaryTableName + "." + columnText + ";");
                            yaz.WriteLine("\t\t\t\t\t}");
                            yaz.WriteLine("");
                        }
                ...
                yaz.WriteLine("\t\t\t}");
                yaz.WriteLine("");
                yaz.WriteLine("\t\t\treturn Json(" + Table + "List);");
                yaz.WriteLine("\t\t}");
                yaz.WriteLine("");
                ...
                if (chkRTables.Checked == true)
                {
                    if (fkcListForeign.Count > 0)
                    {
                        foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                        {
                            ...
                            yaz.WriteLine("\t\t\tif (table" + PrimaryTableName + ".HasData)");
                            yaz.WriteLine("\t\t\t{");
                            yaz.WriteLine("\t\t\t\tforeach (" + PrimaryTableName + " item in table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">)");
                            yaz.WriteLine("\t\t\t\t{");
                ...
                yaz.WriteLine("\t\tpublic ActionResult Ekle(" + Table + " _" + Table + ")");
                yaz.WriteLine("\t\t{");
                yaz.WriteLine("\t\t\tif (ModelState.IsValid)");
                yaz.WriteLine("\t\t\t{");
                yaz.WriteLine("\t\t\t\tTable<" + Table + "> table = new Table<" + Table + ">();");
                yaz.WriteLine("\t\t\t\ttable.Values = _" + Table + ";");
                ...
                if (chkRTables.Checked == true)
                {
                    if (fkcListForeign.Count > 0)
                    {
                        foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                        {
                            ...
                            yaz.WriteLine("\t\t\t\tforeach (" + PrimaryTableName + " item in table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">)");
                            yaz.WriteLine("\t\t\t\t{");
                            yaz.WriteLine("\t\t\t\t\t_" + Table + "." + PrimaryTableName + "List.Add(new SelectListItem() { Value = item." + fkc.PrimaryColumnName + ".ToString(), Text = item." + columnText + " });");
                            yaz.WriteLine("\t\t\t\t}");
                            yaz.WriteLine("\t\t\t}");
                            yaz.WriteLine("");
                        }
                ...
                yaz.WriteLine("\t\t\treturn View(\"Ekle\", _" + Table + ");");
                yaz.WriteLine("\t\t}");
                yaz.WriteLine("");
                ...
                if (identityColumns.Count > 0)
                {
                    ...
                    yaz.WriteLine("\t\t\tTable<" + Table + "> table = new Table<" + Table + ">();");
                    yaz.WriteLine("\t\t\ttable.WhereList.Add(new Where(" + Table + "Columns." + id + ", id));");
                    yaz.WriteLine("\t\t\ttable.Select();");
                    yaz.WriteLine("");
                    yaz.WriteLine("\t\t\tif (table.HasData)");
                    yaz.WriteLine("\t\t\t{");
                    yaz.WriteLine("\t\t\t\t" + Table + "List = table.Data as List<" + Table + ">;");
                    yaz.WriteLine("\t\t\t\t" + Table + " = " + Table + "List.FirstOrDefault();");
                    yaz.WriteLine("");
                    ...
                    if (chkRTables.Checked == true)
                    {
                        if (fkcListForeign.Count > 0)
                        {
                            foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                            {
                                ...
                                yaz.WriteLine("\t\t\t\tTable<" + PrimaryTableName + "> table" + PrimaryTableName + " = new Table<" + PrimaryTableName + ">();");
                                yaz.WriteLine("\t\t\t\ttable" + PrimaryTableName + ".SelectSettings.Top = 1;");
                                yaz.WriteLine("\t\t\t\ttable" + PrimaryTableName + ".WhereList.Add(new Where(" + PrimaryTableName + "Columns." + fkc.PrimaryColumnName + ", " + Table + "." + fkc.ForeignColumnName + "));");
                                yaz.WriteLine("\t\t\t\ttable" + PrimaryTableName + ".Select();");
                                yaz.WriteLine("");
                                yaz.WriteLine("\t\t\t\tif (table" + PrimaryTableName + ".HasData)");
                                yaz.WriteLine("\t\t\t\t{");
                                yaz.WriteLine("\t\t\t\t\t" + PrimaryTableName + " " + PrimaryTableName + " = (table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">).FirstOrDefault();");
                                yaz.WriteLine("\t\t\t\t\t" + Table + "." + PrimaryTableName + "List.Add(new SelectListItem() { Value = " + PrimaryTableName + ".ID.ToString(), Text = " + PrimaryTableName + "." + columnText + ", Selected = true });");
                                yaz.WriteLine("\t\t\t\t}");
                                yaz.WriteLine("");
                            }
                        }
                    ...
                    if (chkRTables.Checked == true)
                    {
                        if (fkcListForeign.Count > 0)
                        {
                            foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                            {
                                ...
                                yaz.WriteLine("\t\t\t\t\tforeach (" + PrimaryTableName + " item in table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">)");
                                yaz.WriteLine("\t\t\t\t\t{");
                                yaz.WriteLine("\t\t\t\t\t\tif (" + Table + "." + fkc.ForeignColumnName + " == item." + fkc.PrimaryColumnName + ")");
                                yaz.WriteLine("\t\t\t\t\t\t{");
                    ...
                    yaz.WriteLine("\t\t\t}");
                    yaz.WriteLine("");
                    yaz.WriteLine("\t\t\treturn View(\"Index\");");
                    yaz.WriteLine("\t\t}");
                    yaz.WriteLine("");
                    yaz.WriteLine("\t\t[HttpPost, ValidateInput(false)]");
                    yaz.WriteLine("\t\tpublic ActionResult Duzenle(" + Table + " _" + Table + ")");
                    yaz.WriteLine("\t\t{");
                    yaz.WriteLine("\t\t\tif (ModelState.IsValid)");
                    yaz.WriteLine("\t\t\t{");
                    yaz.WriteLine("\t\t\t\tTable<" + Table + "> table = new Table<" + Table + ">();");
                    yaz.WriteLine("\t\t\t\ttable.Values = _" + Table + ";");
                    yaz.WriteLine("\t\t\t\ttable.WhereList.Add(new Where(" + Table + "Columns." + id + ", _" + Table + "." + id + "));");
                    ...
                    if (chkRTables.Checked == true)
                    {
                        if (fkcListForeign.Count > 0)
                        {
                            foreach (ForeignKeyChecker fkc in fkcListForeign.GroupBy(a => a.PrimaryTableName).Select(a => a.First()).ToList())
                            {
                                ...
                                yaz.WriteLine("\t\t\t\tforeach (" + PrimaryTableName + " item in table" + PrimaryTableName + ".Data as List<" + PrimaryTableName + ">)");
                                yaz.WriteLine("\t\t\t\t{");
                                yaz.WriteLine("\t\t\t\t\tif (_" + Table + "." + fkc.ForeignColumnName + " == item." + fkc.PrimaryColumnName + ")");
                                yaz.WriteLine("\t\t\t\t\t{");
                                yaz.WriteLine("\t\t\t\t\t\t_" + Table + "." + PrimaryTableName + "List.Add(new SelectListItem() { Value = item." + fkc.PrimaryColumnName + ".ToString(), Text = item." + columnText + ", Selected = true });");
                                yaz.WriteLine("\t\t\t\t\t}");
                                yaz.WriteLine("\t\t\t\t\telse");
                                yaz.WriteLine("\t\t\t\t\t{");
                                yaz.WriteLine("\t\t\t\t\t\t_" + Table + "." + PrimaryTableName + "List.Add(new SelectListItem() { Value = item." + fkc.PrimaryColumnName + ".ToString(), Text = item." + columnText + " });");
                    ...
                    yaz.WriteLine("\t\t\treturn View(\"Duzenle\", _" + Table + ");");
                    yaz.WriteLine("\t\t}");
                    yaz.WriteLine("");
                    ...
                    yaz.WriteLine("\t\t{");
                    yaz.WriteLine("\t\t\tTable<" + Table + "> table = new Table<" + Table + ">();");
                    yaz.WriteLine("\t\t\ttable.WhereList.Add(new Where(" + Table + "Columns." + id + ", conditions));");
        ...
        void CreateMVCEFControllerLayer()
        {
            int i = 0;
        ...
        void CreateTDWebConfig()
        {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Web.config", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    ...
                    yaz.WriteLine("\t\t<add name=\"TDConnection\" connectionString=\"Data Source=.;Initial Catalog=" + DBName + ";User ID=" + wcKullanici + ";Password=" + wcSifre + ";\"/>");
                    yaz.WriteLine("\t</connectionStrings>");
        ...
        {
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Views\\Web.config", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("<?xml version=\"1.0\"?>");
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Areas\\Admin\\Views\\Web.config", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("<?xml version=\"1.0\"?>");
        ...
        void CreateStilScript()
        {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\js\\admin.js", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("$(document).ready(function() {");
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Content\\css\\admin.css", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    yaz.WriteLine("* {outline: none;}");
        ...
        void CreateTDWcfServis()
        {
            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\Servis\\Condition\\SELECT.cs", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    ...
                    yaz.WriteLine("");
                    yaz.WriteLine("\t\t[DataMember]");
                    yaz.WriteLine("\t\tpublic string[] columns { get; set; }");
                    yaz.WriteLine("\t}");
                    yaz.WriteLine("}");
