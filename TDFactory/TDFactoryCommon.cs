            ...
            using (FileStream fs = new FileStream(PathAddress + "\\" + projectFolder + "\\StoredProcedures\\_UsersData.sql", FileMode.Create))
            {
                using (StreamWriter yaz = new StreamWriter(fs, Encoding.Unicode))
                {
                    ...
                    if(hasLogs)
                    {
                        ...
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogTypes] ([ID], [Name], [ShortName]) VALUES (1, N'Site Erişim İşlemleri', N'io')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogTypes] ([ID], [Name], [ShortName]) VALUES (2, N'Tablo İşlemleri', N'tp')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("SET IDENTITY_INSERT [dbo].[LogTypes] OFF");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("SET IDENTITY_INSERT [dbo].[LogProcess] ON");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (1, 1, N'Giriş', N'grs', N'Siteye giriş yapma işlemi')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (2, 1, N'Çıkış', N'cks', N'Siteden çıkış yapma işlemi')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (3, 2, N'Listele', N's', N'Tablo Listeleme Olayı.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (4, 2, N'Ekle', N'i', N'Tabloya Veri Ekleme Olayı.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (5, 2, N'Düzenle', N'u', N'Tablodaki Veriyi Düzenleme Olayı.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (6, 2, N'Sil', N'd', N'Tablodaki Veriyi Gerçekten Silme Olayı. Geri Dönüşsüz.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (7, 2, N'Kaldır', N'r', N'Tablodaki Veriyi Silme Olayı. Silinen Veri Kurtarılabilir.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (8, 2, N'Kopyala', N'c', N'Tablodaki Veriyi Kopyalama Olayı.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (9, 2, N'Grup Değiştir', N'cg', N'Tablodaki Verinin Bağlı Olduğu Grubu Değiştirme Olayı.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("INSERT [dbo].[LogProcess] ([ID], [LogTypeID], [Name], [ShortName], [Description]) VALUES (10, 2, N'Temizle', N't', N'Tablodaki Verilerin Tamamını Silme Olayı. Geri Dönüşsüz.')");
                        yaz.WriteLine("GO");
                        yaz.WriteLine("SET IDENTITY_INSERT [dbo].[LogProcess] OFF");
                        yaz.WriteLine("GO");
